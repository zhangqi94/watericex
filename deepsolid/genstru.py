...
if __name__ == '__main__':
    ...
    ## around 60 45 47 48 50
    # Ls = np.array([2.764030,
    #             2.833809, # 45
    #             2.824098, # 47
    #             2.819217, # 48
    #             2.809692, # 60
    ...
    list_d = np.arange(0, 0.9, 0.005)
    num_stru = len(list_d)
    
    for i in range(num_stru):
        d = list_d[i]
        save_path = f"/home/zhangqi/t02codeml/watericex_deepsolid/data_mini_stru/"
        os.makedirs(save_path, exist_ok=True)
        
        file_name = save_path + f"p_{p:.2f}_a_{a:.6f}_d_{d:.6f}.vasp"
