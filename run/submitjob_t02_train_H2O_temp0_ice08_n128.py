...
for i in range(len(list_p)):
    ...
    press = list_p[i]
    init_stru_path=f"src/structures/relax/ice08c_n128_p{press:.2f}.vasp"
    init_box_path="None"
    load_bond_indices="src/structures/bond_indices/ice08c_n128.txt"
    isotope="H2O"
    temperature=100.0
    num_levels=20
    ...
    folder="/data/zhangqidata/iceX/train_temp100_n128_t02/"
    input_string=f"{isotope}_ice08_n128_p_{press:.2f}"
    epoch_finished=0
    epoch_total=6000
    epoch_ckpt=1000
    load_ckpt="None"
...
python3 submitjob_t02_train_H2O_temp0_ice08_batch.py
"""
