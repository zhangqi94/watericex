...
partition = "a100,v100,a800"
gpus = "1"
num_devices = 1

####################################################################################################
list_p = [20, 30, 40, 50, 55, 60, 61, 62, 63, 64, 65, 66, 67, 68, 69, 70, 75, 80, 90, 100, 110, 120]
...
for i in range(len(list_p)):
    ...
    press = list_p[i]
    init_stru_path=f"src/structures/relax/ice08c_n016_p300.00.vasp"
    init_box_path=f"src/structures/relax/ice08c_n016_p{press:.2f}.vasp"
    ...
    folder="/data/zhangqidata/iceX/train_temp0_t02/"
    input_string=f"{isotope}_ice10_n016_p_{press:.2f}"
    epoch_finished=0
    epoch_total=6000
    epoch_ckpt=1000
    load_ckpt="None"
...
python3 submitjob_t02_train_H2O_temp0_ice10_batch.py
"""
